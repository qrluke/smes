...
if enable_sentry then
  ...
  if sentry_loaded and Sentry then
    pcall(Sentry().init, { dsn = "https://9a6b9c78b1854eef92307e6398401243@o1272228.ingest.sentry.io/6530173" })
  end
end
...
if enable_autoupdate then
  ...
  if updater_loaded then
    ...
    if autoupdate_loaded then
      Update.json_url = "https://raw.githubusercontent.com/qrlk/smes/master/version.json?" .. tostring(os.clock())
      Update.prefix = "[" .. string.upper(thisScript().name) .. "]: "
      Update.url = "https://github.com/qrlk/smes"
    end
  end
end
...
* UPD: Система автообновления заменена на более стабильную.
  ...
  v28.08.2021
* UPD: Адаптация под изменения названий серверов самп-рп.  
